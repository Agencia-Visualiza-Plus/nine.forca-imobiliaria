    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-paper-muted">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 z-10 p-3">
          <div className="flex max-w-[calc(100%-2.75rem)] flex-wrap gap-1.5">
            <span className="whitespace-nowrap rounded-full bg-ink/85 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-white backdrop-blur">
              {transactionLabels[property.transactionType]}
            </span>
            {property.status !== "disponivel" && (
              <span className="whitespace-nowrap rounded-full bg-brand px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-white">
                {statusLabels[property.status]}
              </span>
            )}
            {property.isDemo && (
              <span className="whitespace-nowrap rounded-full bg-white/90 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-ink-600 backdrop-blur">
                Demonstração
              </span>
            )}
          </div>
